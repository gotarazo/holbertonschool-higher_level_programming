#!/usr/bin/python3
"""module for use in testing base class"""
...
class TestBase(unittest.TestCase):
    ...
    def test_read_from_file_empty(self):
        """tests the base class method to read from json files when empty"""
        try:
    ...
    def test_write_csv_complex(self):
        """tests the base class method to write instances as csv with bad input"""
